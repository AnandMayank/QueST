...
- **Dataset:** the QueST-PartNetMobility-SAPIEN dataset (HF, link withheld during anonymous review), stratified sample of 39 sequences across all 4 manipulation levels, downloaded to `~/data/quest_partnet_subset`. 1 sequence (`manipulation_3/41003/take_00`) has incomplete upstream frame extraction and is skipped throughout.
